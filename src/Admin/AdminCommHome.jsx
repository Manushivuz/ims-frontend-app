...
const AdminCommHome = () => {
    useTitle("Admin - Communication Tickets");
    ...
    const filteredTickets =
        selectedTab === "All" ? tickets : tickets.filter((t) => t.status === selectedTab);

    return (
        <>
            <CustomNavbar />
            <div className="p-6 max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold mb-6">Communication Tickets (Admin View)</h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
                    {statusOptions.map((status) => (
                        <div
                            key={status}
                            className={`rounded-xl shadow-sm p-4 ${selectedTab === status ? "bg-blue-100" : "bg-white"
